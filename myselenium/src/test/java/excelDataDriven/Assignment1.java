...
public class Assignment1 
{
	...
	{
		FileInputStream fis = new FileInputStream("C:\\Users\\user\\Desktop\\Selenium\\ExcelData\\data.xlsx");
		...
		fos = new FileOutputStream("C:\\Users\\user\\Desktop\\Selenium\\ExcelData\\data.xlsx");
		wb.write(fos);
		wb.close();
		fos.close();
	}
